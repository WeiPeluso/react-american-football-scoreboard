...
function App() {
  ...
  const homeTouchDown = event => {
    setScore({homeScore:score.homeScore+7, awayScore: score.awayScore}) 
  }
  const homeFieldGoal= event => {
    setScore({homeScore:score.homeScore+3,awayScore: score.awayScore}) 
  }
  const awayTouchDown= event => {
    setScore({homeScore: score.homeScore,awayScore:score.awayScore+7}) 
  }
  const awayFieldGoal = event => {
    setScore({homeScore: score.homeScore, awayScore:score.awayScore+3}) 
  }
